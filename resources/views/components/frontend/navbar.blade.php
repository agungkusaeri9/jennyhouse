            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item submenu dropdown @if (Route::currentRouteName() === 'products.index' ||
                                Route::currentRouteName() === 'products.show' ||
                                Route::currentRouteName() === 'products.category') active @endif">
                        ...
                        @auth
                            <li class="nav-item  @if (Route::currentRouteName() === 'transactions.index') active @endif"><a class="nav-link"
